...
\usepackage{fancyhdr}
\pagestyle{fancy}
\lhead{Muhammad Fadil Ataullah Rifqi (122140205)}
\rhead{ \thepage}
...
\begin{itemize}
    \item Tool manajemen environment yang Anda pilih: \textbf{Venv}

    \item Screenshot atau copy-paste output dari perintah verifikasi environment:

    \begin{center}
        \includegraphics[width=0.7\textwidth]{screenshots/ss1.png}
    \end{center}
...
\textbf{Dokumentasikan di sini:}
\begin{itemize}
    \item Perintah instalasi yang Anda gunakan: \textbf{Venv dengan pip}
    \item Screenshot proses instalasi atau output sukses
    \begin{center}
        \includegraphics[width=0.7\textwidth]{screenshots/ss2.png}
    \end{center}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{screenshots/ss3.png}
    \end{center}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{screenshots/ss4.png}
    \end{center}
    \begin{center}
        \includegraphics[width=0.7\textwidth]{screenshots/ss5.png}
    \end{center}
    \item Daftar library yang berhasil diinstall dengan versinya
    \begin{itemize}
        \item NumPy Versi 2.2.6
        \item Pandas Versi 2.3.3
        \item MoviePy Versi 2.1.2
        \item OpenCV Versi 4.12.0
        \item Matplotlib Versi 3.10.7
        \item scikit-image Versi 0.25.2
        \item Librosa Versi 0.11.0
        \item SoundFile Versi 0.13.1
        \item SciPy Versi 1.16.3
        \item Pillow Versi 11.3.0
    \end{itemize}
\end{itemize}
...
\begin{center}
    \includegraphics[width=0.7\textwidth]{screenshots/ss6.png}
    \includegraphics[width=0.7\textwidth]{screenshots/ss7.png}
\end{center}
...
\begin{itemize}
    ...
    \begin{center}
        \includegraphics[width=0.7\textwidth]{screenshots/audio.png}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item sebelum aktivasi environment
        \begin{center}
            \includegraphics[width=0.7\textwidth]{screenshots/sebelum.png}
        \end{center}
        \item setelah aktivasi environment
        \begin{center}
            \includegraphics[width=0.7\textwidth]{screenshots/sesudah.png}
        \end{center}
    \end{itemize}
...
\begin{enumerate}
    ...
    \textit{[Untuk mencegah konflik dependency antar library yang membutuhkan versi berbeda]}

    \item \textbf{Apa perbedaan utama antara conda, venv, dan uv? Mengapa Anda memilih tool yang Anda gunakan?}

    \textit{[dari segi kecepatan dan library yang tersedia]}

    \item \textbf{Library mana yang paling sulit diinstall dan mengapa?}

    \textit{[sejauh saya menjalankan instalasi di atas tidak ada error / kendala namun perbedaan nama library dan cara import menjadi kendala saat ingin tes seperti library pillow]}

    \item \textbf{Bagaimana cara mengatasi masalah dependency conflict jika terjadi?}

    \textit{[mencari di dokumentasi resmi library tersebut]}

    \item \textbf{Jelaskan fungsi dari masing-masing library yang berhasil Anda install!}


    \begin{itemize}
        \item NumPy: Untuk mempermudah perhitungan seperti banyak fungsi matematika yang ada di numpy
        \item Pandas: Untuk manipulasi dan analisis data seperti csv xlsx dll
        \item MoviePy: Untuk manipulasi video
        \item OpenCV: Untuk pengolahan citra dan computer vision
        \item Matplotlib: Untuk visualisasi data
        \item scikit-image: Untuk pengolahan citra
        \item Librosa: Untuk analisis dan manipulasi audio
        \item SoundFile: Untuk membaca dan menulis file audio
        \item SciPy: Untuk komputasi ilmiah dan teknis
...
\begin{itemize}
    \item \textbf{Masalah 1:} \textit{[Mendownload latex compiler]}

    \textbf{Solusi:} \textit{[Mencari tutorial di internet dan mengikuti langkah-langkahnya]}
...
\begin{itemize}
    \item Pengalaman setup Python environment untuk multimedia : Cukup mudah diikuti langkah-langkahnya
    \item Persiapan untuk project multimedia selanjutnya : Dengan adanya environment yang sudah terpisah ini diharapkan tidak ada konflik dependency di project selanjutnya
    \item Saran untuk mahasiswa lain yang akan melakukan setup serupa : Jika menemukan kesulitan instalasi disarankan untuk membaca dokumentassi resmi terlebih dahulu karena biasanya sudah lengkap caranya disitu
\end{itemize}
...
\begin{itemize}
    \item \url{https://tug.org/texlive/quickinstall.html}
    \item \url{https://pillow.readthedocs.io/en/stable/handbook/tutorial.html}
\end{itemize}
